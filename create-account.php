...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        // Server-side validation: Allow +65 or local 8-digit numbers starting with 8 or 9
        if (!preg_match('/^(\\+65\\s?)?[89][0-9]{7}$/', $tele)) {
            $error = '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Mobile number must be 8 digits starting with 8 or 9, with optional +65 prefix (Singapore numbers).</label>';
        } else {
